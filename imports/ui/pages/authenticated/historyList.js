...
Template.historyList.onDestroyed(function () {
	  Session.keys = {};
});

Template.historyList.onRendered(function(){
...
Template.historyList.helpers({
	bookings(){
		...
		conditions.push({'status': {$ne: 'Paid'}});
